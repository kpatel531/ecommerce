        ...
        <div className='bg-white p-4 w-full max-w-lg mt-8 mx-auto rounded'>
            ...
            <form className='mt-4 grid gap-4' onSubmit={handleSubmit(onSubmit)}>
                <div className='grid gap-1'>
                    <label className='font-medium' htmlFor='addressline'>Address Line :</label>
                    <input
                        type='text'
                        id='addressline' 
                        className='font-normal border bg-blue-50 p-2 rounded'
                ...
                <button type='submit' className='bg-primary-200 w-full hover:text-white py-2 font-semibold mt-4 hover:bg-primary-100'>Submit</button>
            </form>
        </div>
    </section>
  )
